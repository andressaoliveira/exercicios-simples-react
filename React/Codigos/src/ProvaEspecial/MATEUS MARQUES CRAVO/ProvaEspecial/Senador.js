...
export class Senador extends React.Component {
    ...
    render() {
        const { showState, identificacaoParlamentar, dadosBasicos, outrasInformacoes } = this.state; 
        ...
        return (
            <div className="flex-9">
                ...
                <button name="retornaSenador" type='button' onClick={this.retornaDados}>Buscar</button>
